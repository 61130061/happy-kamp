        ...
        <div className="flex-1 p-5 md:p-0">
          ...
          {cart.cart_list.length > 0 ?
            ...
            <div className="space-y-2 pt-16 pb-28 text-center border-b">
              ...
              <Link href="/shopping-cart" className="flex items-center gap-3 justify-center text-primary-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
        ...
        {cart.cart_list.length > 0 &&
          <div className="p-5 md:p-0 md:w-[30%]">
            ...
            <div className="flex flex-col gap-5 text-sm">
              <Link href="/checkout">
                <button className="bg-primary-1 hover:bg-primary-3 w-full text-primary-2 py-3">Checkout</button>
              </Link>
