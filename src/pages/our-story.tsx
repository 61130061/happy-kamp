...
export const getServerSideProps: GetServerSideProps<{ img: string }> = async (
  context,
) => {
    ...
    >
      <>
        <Image
          ...
          height={645}
          width={645}
          className="object-cover w-full h-[645px]"
          src={img}
        />

        <div className="flex flex-col gap-8 text-center py-14 max-w-3xl mx-auto px-5">
          ...
          <p>
            ...
            can start adding your own content and make changes to the font. Feel
