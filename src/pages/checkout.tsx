    ...
    <>
      ...
      <main>
        <div className="w-screen h-screen md:overflow-hidden">
          ...
          <Link href="/">
            <div aria-label="top-logo" className="text-center text-3xl font-[200] tracking-[0.2em] my-5 md:my-16">happy kids</div>
          </Link>
          ...
          {success ? <ConfirmPage /> :
            <div className="md:flex md:flex-row flex flex-col-reverse gap-0 md:gap-5 max-w-4xl mx-auto">
              ...
              <div className="flex-1 p-5 md:m-0 m-3 border rounded-lg">
                <Link href="/shopping-cart" className="flex w-fit items-center gap-3 text-gray-400 hover:text-black">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="md:flex space-y-2 md:space-y-0 gap-3">
                      <label className="flex flex-1 gap-1 flex-col">
                        First Name
                        <input className="border rounded p-1" placeholder="Tom" />
                      </label>
                      <label className="flex flex-1 gap-1 flex-col">
                        Last Name
                        <input className="border rounded p-1" placeholder="James" />
                      </label>
                    </div>
                    <label className="flex flex-1 gap-1 flex-col">
                      Address
                      <input className="border rounded p-1" placeholder="23/33 NYC" />
                    </label>
                  </div>
                  <div className="space-y-2 text-sm">
...
function ConfirmPage () {
  return (
    <div className="h-[60%] flex flex-col gap-5 items-center">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-14 h-14 text-green-400">
      ...
      <Link href="/">
        <button className="flex gap-3 items-center justify-center p-3 text-red-400">
